...
reffunc = takuReffunc_SRActFlow_v1(EDATImport, 'PitchStim');
...
[dmat, dLabels] = ReffuncToAFNI(reffunc_vector, subjNumStr, 8, [1:8], [581 581 581 581 581 581 581 581], .785,...
    ...
    {'\w*_stim1_\w*high_stim2_\w*high_\w*', '\w*_stim1_\w*high_stim2_\w*low_\w*', ...
    '\w*_stim1_\w*low_stim2_\w*high_\w*', '\w*_stim1_\w*low_stim2_\w*low_\w*',},...
    1, 1, 'PITCHSTIM')
