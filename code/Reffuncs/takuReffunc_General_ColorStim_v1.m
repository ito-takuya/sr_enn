...
reffunc = takuReffunc_SRActFlow_v1(EDATImport, 'ColorStim');
...
[dmat, dLabels] = ReffuncToAFNI(reffunc_vector, subjNumStr, 8, [1:8], [581 581 581 581 581 581 581 581], .785,...
    {'REDRED', 'REDBLUE', 'BLUERED', 'BLUEBLUE'},...
    {'\w*_stim1_red\w*_stim2_red\w*', '\w*_stim1_red\w*_stim2_blue\w*','\w*_stim1_blue\w*_stim2_red\w*', '\w*_stim1_blue\w*_stim2_blue\w*',},...
    1, 1, 'COLORSTIM')
