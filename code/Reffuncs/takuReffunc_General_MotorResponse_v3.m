...
reffunc = takuReffunc_SRActFlow_v1(EDATImport, 'MotorResponse');
...
[dmat, dLabels] = ReffuncToAFNI(reffunc_vector, subjNumStr, 8, [1:8], [581 581 581 581 581 581 581 581], .785,...
    ...
    {'\w*_motorResp_b_\w*', '\w*_motorResp_y_\w*', '\w*_motorResp_r_\w*','\w*_motorResp_g_\w*'},...% byrg (rather than bygr) to keep ordering of digits consistent
    1, 1, 'CPRO_MotorResponse')
