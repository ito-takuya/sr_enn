...
reffunc = takuReffunc_SRActFlow_v1(EDATImport, 'OriStim');
...
[dmat, dLabels] = ReffuncToAFNI(reffunc_vector, subjNumStr, 8, [1:8], [581 581 581 581 581 581 581 581], .785,...
    {'VERTICALVERTICAL', 'VERTICALHORIZONTAL', 'HORIZONTALVERTICAL', 'HORIZONTALHORIZONTAL'},...
    {'\w*_stim1_\w*vertical\w*_stim2_\w*vertical\w*', '\w*_stim1_\w*vertical\w*_stim2_\w*horizontal\w*', ...
    '\w*_stim1_\w*horizontal\w*_stim2_\w*vertical\w*', '\w*_stim1_\w*horizontal\w*_stim2_\w*horizontal\w*',},...
    1, 1, 'ORISTIM')
