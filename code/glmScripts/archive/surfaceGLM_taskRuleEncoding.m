function output = surfaceGLM_taskRuleEncoding(subj, gsr, nproc)
...
%   subj = subject number as a string
    ...
    X = loadStimFiles_taskRuleEncoding(subj,gsr);
    ...
    if gsr==0
        outname1 = ['/projects3/StroopActFlow/data/results/glm_taskruleencoding/' subj '_taskruleEncoding_nuisanceResids_Surface64k.csv'];
        
    elseif gsr==1
        outname1 = ['/projects3/StroopActFlow/data/results/glm_taskruleencoding/' subj '_taskruleEncoding_nuisanceResids_Surface64k_noGSR.csv'];
    end
    outname2 = ['/projects3/StroopActFlow/data/results/glm_taskruleencoding/' subj '_taskruleEncoding_taskBetas_Surface64k.csv'];
