function output = surfaceGLM_neutralStimuliByTrial(subj, gsr, nproc)
...
%   subj = subject number as a string
    ...
    X = loadStimFiles_neutralStimuliByTrial(subj,gsr);
    ...
    if gsr==0
        outname1 = ['/projects3/StroopActFlow/data/results/glm_neutral_stimuli/' subj '_neutralStimuliByTrial_nuisanceResids_Surface64k.csv'];
        
    elseif gsr==1
        outname1 = ['/projects3/StroopActFlow/data/results/glm_neutral_stimuli/' subj '_neutralStimuliByTrial_nuisanceResids_Surface64k_noGSR.csv'];
    end
    outname2 = ['/projects3/StroopActFlow/data/results/glm_neutral_stimuli/' subj '_neutralStimuliByTrial_taskBetas_Surface64k.csv'];
