function output = GlasserGLM_motorResponseLocalization(subj, gsr, nproc)
...
%   subj = subject number as a string
    ...
    X = loadStimFiles_motorResponseLocalizer(subj,gsr);
    ...
    if gsr==0
        outname1 = ['/projects3/StroopActFlow/data/results/GlasserResults/glm_motorResponseLocalizer/' subj '_motorResponse_nuisanceResids_Surface64k.csv'];
        
    elseif gsr==1
        outname1 = ['/projects3/StroopActFlow/data/results/GlasserResults/glm_motorResponseLocalizer/' subj '_motorResponse_nuisanceResids_Surface64k_noGSR.csv'];
    end
    outname2 = ['/projects3/StroopActFlow/data/results/GlasserResults/glm_motorResponseLocalizer/' subj '_motorResponse_taskBetas_Surface64k.csv'];
    outname3 = ['/projects3/StroopActFlow/data/results/GlasserResults/glm_motorResponseLocalizer/' subj '_motorResponse_taskTstat_Surface64k.csv'];
    outname4 = ['/projects3/StroopActFlow/data/results/GlasserResults/glm_motorResponseLocalizer/' subj '_motorResponse_taskPval_Surface64k.csv'];
