function output = surfaceGLM_hiddenLayerLocalizer(subj, gsr, nproc)
...
%   subj = subject number as a string
    ...
    X = loadStimFiles_hiddenLayerLocalizer(subj,gsr);
    ...
    if gsr==0
        outname1 = ['/projects3/StroopActFlow/data/results/glm_motorResponseLocalizer/' subj '_hiddenLayer_nuisanceResids_Surface64k.csv'];
        
    elseif gsr==1
        outname1 = ['/projects3/StroopActFlow/data/results/glm_motorResponseLocalizer/' subj '_hiddenLayer_nuisanceResids_Surface64k_noGSR.csv'];
    end
    outname2 = ['/projects3/StroopActFlow/data/results/glm_hiddenLayerLocalizer/' subj '_hiddenLayer_taskBetas_Surface64k.csv'];
    outname3 = ['/projects3/StroopActFlow/data/results/glm_hiddenLayerLocalizer/' subj '_hiddenLayer_taskTstat_Surface64k.csv'];
    outname4 = ['/projects3/StroopActFlow/data/results/glm_hiddenLayerLocalizer/' subj '_hiddenLayer_taskPval_Surface64k.csv'];
