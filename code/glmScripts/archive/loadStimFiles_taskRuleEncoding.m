function output = loadStimFiles_taskRuleEncoding(subj, gsr)
% Taku Ito
% 01/13/2017
%
...
%   gsr - 1 if you would like to include a GSR regressor in the matrix, 0 if not   
    ...
    numTaskStims = 2; % 4 stimuli (neutral); localizers
    ...
    for stim=1:numTaskStims
        stimdir = '/projects3/StroopActFlow/data/stimfiles/TaskRuleEncodings/';
...
%    stimMat2 = zeros(totalTRs,numTaskStims*nBlocksPerRule);
%    trialCount = 1;
%    for stim=1:numTaskStims
%        tr = 1;
